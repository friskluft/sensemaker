...
./nyxus.exe --features=*basic_morphology* --verbosity=2 --intDir=/home/ec2-user/work/data/hamda_bbox/int --segDir=/home/ec2-user/work/data/hamda_bbox/seg --outDir=/home/ec2-user/work/data/OUTPUT_hamda --filePattern=.* --csvFile=separatecsv --loaderThreads=1 --reduceThreads=4 

...
DATADIR="/home/ec2-user/work/data/hamda-cellprofiler-bench"
...
./nyxus.exe --verbosity=3 --features=*all* --intDir=$DATADIR/int --segDir=$DATADIR/seg --outDir=$OUTDIR --filePattern=test.* --csvFile=singlecsv --loaderThreads=1 --reduceThreads=8 
